...
![UI-module](https://github.com/becodeorg/BXL-Johnson-09-main-repo/blob/main/3.The-Mountain/Frontend/1.React-basics/images/ui-module.png)
...
### What is "JSX"? Another  strange innovation of facebook engineers?
...
_Oh, by the way, have I mentioned a small but important difference between JSX and HTML? In JSX we have to use `className` instead of `class` (That's the closest word they found to `class` that was not already reserved in JavaScript).

Notice also how they cleverly used syntax so we can write JS inside the {} and HTML inside the ()_
...
And that's what we call the react thinking ! You'll get to it soon enough.
...
<iframe src="https://giphy.com/embed/TnMLyexfHe9lC" width="300" height="270" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/blizzard-ent-TnMLyexfHe9lC">via GIPHY</a></p>